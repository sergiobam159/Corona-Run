...
public class Provision extends InputAdapter {
    Texture img;
    ...
    public Provision(Viewport viewport, int tipo) {
        this.viewport = viewport;

        this.tipo = tipo;
        switch (tipo) {
            case 1:
                img = new Texture("alcoholTiny.png");
                break;
            case 2:
                img = new Texture("jabonTiny.png");
                break;
            case 3:
                img = new Texture("mascarillaTiny.png");
                break;
            case 4:
                img = new Texture("alcoholTiny.png");
                break;
    ...
    public void render(float delta, float aleatorio) {
        ...
        if (posicion.y < -40) {
            posicion.y = Math.round((Math.random() * ((700 - 400) + 1)) + 600);
